...
const editingEquipment = ref<any | null>(null)
  ...
  >
    ...
    >
      ...
      <p class="text-sm text-slate-500 mb-6">
        Esta acción marcará el equipo como eliminado. Sus registros asociados en el histórico de movimientos se mantendrán intactos.
      </p>
